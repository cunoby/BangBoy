...
local function SortItems(items, stype, asc)
    ...
    table.sort(s, function(a, b)
        ...
        elseif stype == "Price" then
            local va = item and item.listingPrice or 0
...
local TAB_LIST = {
    {id="Listing",   icon="Store",  lbl="Listing"},
    {id="MyBooth",   icon="Booth",  lbl="Booth"},
    {id="Inventory", icon="Bag",    lbl="Inventori"},
    {id="FindSeller",icon="Search", lbl="Cari"},
    {id="History",   icon="Log",    lbl="Riwayat"},
}
local TAB_ICONS = {
    Listing="🏪", Booth="📦", Bag="🎒", Search="🔍", Log="📜",
}
